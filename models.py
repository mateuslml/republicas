...
class Republica(Usuario):
    ...
    def preencher_formulario(self):
        ...
        opcoes = {
            "1": ("República Líder Social", "Essa república é ideal para pessoas sociáveis que gostam de ter a casa organizada e resolver problemas de forma prática e rápida. A casa valoriza eventos em grupo, como reuniões semanais, festas e estudos colaborativos. Os moradores preferem um ambiente animado, mas com regras claras para manter a convivência harmoniosa."),
            "2": ("República Criativa e Livre", "Uma república tranquila e flexível, voltada para quem valoriza privacidade e liberdade. Não existem muitas regras rígidas, e os moradores têm total autonomia sobre seus espaços pessoais. Ideal para pessoas criativas, introspectivas e que gostam de manter a convivência simples e leve, sem muita imposição de rotinas."),
            "3": ("República Harmonia Flex", "Essa república é voltada para estudantes que gostam de equilibrar socialização e privacidade. A convivência é baseada em colaboração, com tarefas divididas de forma justa e flexível. Perfeita para quem quer um ambiente agradável e amigável, mas sem excessos em festas ou regras rígidas."),
            "4": ("República Relax Noturna", "Uma república ideal para pessoas descontraídas e que preferem horários flexíveis. Perfeita para quem gosta de estudar à noite, curtir música, jogar videogames ou até mesmo organizar encontros informais com amigos. Não é a melhor opção para quem gosta de muita ordem ou silêncio constante."),
            "5": ("República Equilíbrio e Paz", "Um ambiente reservado, com regras claras e espaços bem organizados. É a escolha ideal para quem prefere calma, silêncio e foco nos estudos. Conflitos são raros, pois os moradores respeitam as regras e buscam um convívio equilibrado.")
        }
